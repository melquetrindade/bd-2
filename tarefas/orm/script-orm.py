...
engine = create_engine('postgresql://postgres:12ju2002@localhost/atividade_db')
...
stmt1 = tabela_atividade.insert().values(descricao='Tarefa de BD - ORM', projeto=3, data_inicio='2024-04-17', data_fim='2024-04-18')
